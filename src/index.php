...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
    include 'header-after.html'; // Include header for logged-in users
} else {
    include 'header-before.html'; // Include header for non-logged-in users
}
?>
  ...
  <main class="bg-black m-2 min-h-screen">
    ...
    <div class="mt-10 bg-blue-500">
      ...
      <div id="buy-div" class="hidden">
          <div class="grid grid-cols-5 gap-2 bg-blue-500 text-white p-4 rounded-lg">
            <div class="bg-blue-700 p-4 rounded-lg">01</div>
            <div class="bg-blue-700 p-4 rounded-lg">02</div>
            <div class="bg-blue-700 p-4 rounded-lg">03</div>
            <div class="bg-blue-700 p-4 rounded-lg">04</div>
            <div class="bg-blue-700 p-4 rounded-lg">05</div>
          </div>
          <p>This is the "Want to Buy" section.</p>
      </div>
